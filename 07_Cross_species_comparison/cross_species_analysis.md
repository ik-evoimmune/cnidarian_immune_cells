---
title: "Cross-species comparative transcriptomic analysis"
...
## Rows: 13037 Columns: 3
## ── Column specification ───────────────────────
## Delimiter: "\t"
## chr (3): Orthogroup, Nvec, Spi
## 
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-1.png)
...
## 
## data:  orthogroups_sig$avg_log2FC and orthogroups_sig$log2FoldChange
## t = 24.589, df = 3252, p-value < 2.2e-16
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-2.png)

```         
cor.test(orthogroups_sig$avg_log2FC, orthogroups_sig$log2FoldChange, method = "spearman")

## Warning in
## cor.test.default(orthogroups_sig$avg_log2FC,
## orthogroups_sig$log2FoldChange, : Cannot
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-3.png)
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-4.png)
...
##  Pearson's product-moment correlation
## 
## data:  orthogroup_summary$log2FC_Nvec and orthogroup_summary$log2FC_Spi
## t = 27.859, df = 9018, p-value < 2.2e-16
## alternative hypothesis: true correlation is not equal to 0
## 95 percent confidence interval:
##  0.2623903 0.3003956
## sample estimates:
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-5.png)
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-6.png)
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-7.png)
...
## Warning: There were 2513 warnings in `summarise()`.
## The first warning was:
## ℹ In argument: `max_log2FC_nvec =
##   max(avg_log2FC, na.rm = TRUE)`.
## ℹ In group 4: `Orthogroup = "OG0000003"`.
## Caused by warning in `max()`:
## ! no non-missing arguments to max; returning -Inf
## ℹ Run `dplyr::last_dplyr_warnings()` to see
##   the 2512 remaining warnings.
...
## Warning: Removed 2513 rows containing non-finite
## outside the scale range (`stat_smooth()`).
```

![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-8.png)
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-9.png)
...
## Warning: Removed 10 rows containing non-finite outside
## the scale range (`stat_pointdensity()`).
...
## Warning in is.na(x): is.na() applied to
## non-(list or vector) of type 'language'
```

![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-10.png)
...
## Warning: Removed 15 rows containing non-finite outside
## the scale range (`stat_pointdensity()`).
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-11.png)
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-12.png)
...
##   Nvec up orthogroups: 826

cat("  Styl up orthogroups:", length(styl_up_orthos), "\n")

##   Styl up orthogroups: 579
...
##   Nvec down orthogroups: 1573

cat("  Styl down orthogroups:", length(styl_down_orthos), "\n")

##   Styl down orthogroups: 1161
...
![](script/cross_species_analysis_files/figure-markdown_strict/unnamed-chunk-1-13.png)
