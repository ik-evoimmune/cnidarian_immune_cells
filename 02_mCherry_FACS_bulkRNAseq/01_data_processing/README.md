...
This directory contains all steps related to **raw data processing and alignment** for the mCherry FACS bulk RNA-seq dataset. It includes input data, preprocessing and alignment scripts, and quality control summaries generated prior to downstream analysis.
