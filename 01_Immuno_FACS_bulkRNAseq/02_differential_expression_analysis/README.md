...
This directory contains the bulk RNA-seq differential expression and downstream exploratory analyses comparing RLRb+ and RLRb- samples.
...
Key result files include: - `S2_table.csv` – full DESeq2 results and `S3_table.csv` – GSEA enrichment results.
